...
from LAVIS.lavis.datasets.datasets.nlvr_datasets import NLVRDataset, NLVREvalDataset
from LAVIS.lavis.datasets.datasets.snli_ve_datasets import SNLIVisualEntialmentDataset
