...
from LAVIS.lavis.datasets.datasets.aok_vqa_datasets import AOKVQADataset, AOKVQAEvalDataset
from LAVIS.lavis.datasets.datasets.coco_vqa_datasets import COCOVQADataset, COCOVQAEvalDataset
from LAVIS.lavis.datasets.datasets.vg_vqa_datasets import VGVQADataset
from LAVIS.lavis.datasets.datasets.gqa_datasets import GQADataset, GQAEvalDataset
