...
from LAVIS.lavis.datasets.datasets.image_text_pair_datasets import ImageTextPairDataset
from LAVIS.lavis.datasets.datasets.laion_dataset import LaionDataset
