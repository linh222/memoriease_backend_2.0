...
from LAVIS1.lavis.datasets.datasets.nlvr_datasets import NLVRDataset, NLVREvalDataset
from LAVIS1.lavis.datasets.datasets.snli_ve_datasets import SNLIVisualEntialmentDataset
