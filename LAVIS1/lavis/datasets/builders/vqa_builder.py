...
from LAVIS1.lavis.datasets.builders.base_dataset_builder import BaseDatasetBuilder

from LAVIS1.lavis.common.registry import registry
from LAVIS1.lavis.datasets.datasets.aok_vqa_datasets import AOKVQADataset, AOKVQAEvalDataset
from LAVIS1.lavis.datasets.datasets.coco_vqa_datasets import COCOVQADataset, COCOVQAEvalDataset
from LAVIS1.lavis.datasets.datasets.vg_vqa_datasets import VGVQADataset
from LAVIS1.lavis.datasets.datasets.gqa_datasets import GQADataset, GQAEvalDataset
